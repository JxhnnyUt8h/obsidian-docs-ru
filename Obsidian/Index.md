...
- Looking for some functionality? Try the  [[Палитра команд]], which contains all available actions you need to work with Obsidian. Just press `Ctrl/Cmd-P` and start typing.
...
![[Встроенные плагины#Current list of official plugins]]
