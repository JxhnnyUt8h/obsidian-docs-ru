...
- The [[Палитра команд]] contains most of the commands you need to work with Obsidian. Just press `Ctrl/Cmd-P` and start typing.
...
- Obsidian can be extended with [[Встроенные плагины|plugins]]. Several are available by default, and can be enabled or disabled according to your needs.
