...
- If you suspect that a community plugin is malicious, report it to [[Помощь и поддержка#Contact Obsidian support|Obsidian support]], or by sending a DM to our moderators.
