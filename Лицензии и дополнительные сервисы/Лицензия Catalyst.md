...
Для повышения до Catalyst, пожалуйста посетите [нашу страницу с ценами](https://obsidian.md/pricing).

Если вы используете Obsidian для работы, вам может понадобиться [[Коммерческая лицензия|коммерческая лицензия]].

## Часто задаваемые вопросы

### Как я могу получить свой бейдж после повышения?

Поздравляю! После обновления вы найдете две кнопки в разделе Catalyst на странице вашей учетной записи.
...
==Пожалуйста убедитесь что вы зарегистрировали акканут на [нашем форуме](https://forum.obsidian.md) с тем же адресом электронной почты.==
...
Обратите внимание, что ваш бейдж на форуме – это не «значок» в системе форума, а блестящий золотой бэйдж рядом с вашим именем во всех ваших сообщениях.

### Что я получаяю приобретая лицензию Catalyst?
...
### Какие способо оплаты вы принимаете?

Наш сайт принимает кредитные и некоторые дебитные карты. Этот метод самый быстрый и простой.

Если вам нужно оплатить через PayPal или Wechat, это также возможно. Пожалуйста, ознакомьтесь с инструкциями, войдя на наш сайт и выбрав опцию Catalyst.