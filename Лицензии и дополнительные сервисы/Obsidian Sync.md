...
##### Что означает ошибка с текстом `Хранилище слишком большое»`?
...
Если вы видите эту ошибку, Obsidian может помочь вам определить большие файлы и очистить хранилище от них. Это можно сделать в разделе **Настройки => Синхронизация**.