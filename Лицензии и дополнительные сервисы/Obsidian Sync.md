...
Вы можете кликнуть правой кнопкой мыши по файлу в панели файлового менеджера, чтобы увидеть историю его версий. Эта опция также доступна в меню дополнительных параметров.
