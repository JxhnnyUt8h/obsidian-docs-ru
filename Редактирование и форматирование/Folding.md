...
- To collapse all sections, open the [[Палитра команд]], and then select **Fold all headings and lists**.
- To expand all sections, open the [[Палитра команд]], and then select **Unfold all headings and lists**.
