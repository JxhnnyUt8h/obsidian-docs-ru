...
| Option                 | Type   | Description                                                                                                                          |
|------------------------|--------|--------------------------------------------------------------------------------------------------------------------------------------|
| Show navigation        | Toggle | Enable or disable the [[Файловый менеджер]] view on your publish site.                                                                   |
...
| Show table of contents | Toggle | Enable or disable the [[Структура|Table of contents]] view on your site.                                                              |
| Show backlinks         | Toggle | Enable or disable [[Обратные ссылки]] on your site.                                                                                        |
