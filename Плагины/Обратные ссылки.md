...
- **Show search filter** toggles a text field that lets you filter the mentions. For more information on how to build a search query, refer to [[Поиск]].
...
> [!note]
> If you can't see the Backlinks tab, you can make it visible by opening the [[Палитра команд]] and running the **Backlinks: Show backlinks pane** command.
