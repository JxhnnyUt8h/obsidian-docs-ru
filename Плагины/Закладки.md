...
>
> Or, open the Bookmarks tab by running **Bookmarks: Show bookmarks** from the [[Палитра команд]].
...
> **File explorer**:
>
> - Right-click a file in [[Файловый менеджер]] and click **Bookmark**.
>
> **Command palette**:
>
...
> **File explorer**:
>
> - Right-click a folder in [[Файловый менеджер]] and click **Bookmark**.

> [!todo]- Bookmark a search term
>
> **Search**:
>
> 1. Enter a [[Поиск#Search terms|search term]].
