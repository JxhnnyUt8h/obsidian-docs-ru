The File explorer lets you manage files and folders inside your vault. You can browse notes and other [[Поддерживаемые форматы файлов]] in your vault and perform many common file operations:
