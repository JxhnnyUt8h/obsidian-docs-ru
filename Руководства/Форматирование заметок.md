...
Link to a page: [[Внутренняя ссылка]].

---

### Embeds

Embed another file (read more about [[Вложенные файлы]]). Here's an embedded section:
...
[[Использование протокола URI|Obsidian URI]] links can be used to open notes in Obsidian either from another Obsidian vault or another program.

For example, you can link to a file in a vault like so (please note the [[Использование протокола URI#Encoding|required encoding]]):
...
First Header | Second Header
------------ | ------------
[[Форматирование заметок\|Formatting]]	|  [[Сочетания клавиш\|hotkeys]]	
...
`"⨳ special character"`
It looks like this if you follow the [[Форматирование заметок#^376b9d|second option]]:
`A["⨳ special character"]`
