...
To make the link display different text than its real note name in Preview, use the vertical pipe (`Shift+|`) For example: [[Another Page Title Here|Custom Link Name in Preview!]] This can be combined with linking to headers, as in [[Сворачивание списков и заголовков#By way of example|Example of Folding]].
