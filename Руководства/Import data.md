...
> 5. Use our [[Конвертер форматов]] to convert Roam Research's Markdown format into Obsidian's format.
...
If you're importing from Bear, the [[Конвертер форматов]] plugin has an option to convert `::highlight::` to `==highlight==`.
...
In order to fix that, you can use our [[Конвертер форматов]] to convert your Zettelkasten links into either `[[202001010000 My Note]]` or `[[202001010000 My Note|My Note]]`.

You might also be interested in the [[Уникальный идентификатор]] plugin.
