...
If you want to default to opening in reading view rather than edit mode, a toggle for that can be found in the [[Палитра команд]]. You can also set a [[Use hotkeys|Keyboard Shortcut]] for toggling between default states.
