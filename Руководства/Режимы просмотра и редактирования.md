...
If you want to default to opening in preview rather than edit mode, a toggle for that can be found in the [[Палитра команд]]. You can also set a [[Сочетания клавиш|Keyboard Shortcut]] for toggilng between default states.
