...
If you're importing from Bear, the [[Импорт Markdown-файлов]] plugin has an option to convert `::highlight::` to `==highlight==`.
...
You might also be interested in the [[Zettelkasten префикс]] plugin.
