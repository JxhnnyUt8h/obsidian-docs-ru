...
Quick Action defaults to open [[Палитра команд]].
...
The middle plus in circle icon lets you create a new note or switch to an existing note. This is equivalent to opening [[Быстрый переход]].
...
The mobile app has no [[Лента]]. Instead, the ribbon actions will be available when you tap **Open menu** (three bars icon), the last option on the navigation bar.