...
>
> If you want to sync vault configuration, such as settings for [[Предустановленные плагины]], [[Custom hotkeys]], or [[Сторонние плагины]], learn how to [[Select files and settings to sync#Sync vault configuration|Sync vault configuration]].
