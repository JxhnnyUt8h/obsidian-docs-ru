...
If you'd like to use Obsidian for work activities, try to let your work get you a [[Коммерческая лицензия|commercial license]].
...
If you're a JavaScript/TypeScript programmer, you can write [[Сторонние плагины]] for Obsidian, now that our plugin API is in alpha.
